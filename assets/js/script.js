...
const quizArray = [
  ...
  
  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/rose.jpg" alt="A red Rose" >',
...

  {
    ...
    correctAnswer: false,
    imgFile: '<img src="assets/images/crab.jpg" alt=" A Crab" >',
 ...
 
  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/baobab.jpg" alt=" A Baobab">',
  ...
  },
  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/tulips.jpg" alt="Tulips " >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/tiger.jpg" alt="A Tiger " >',
...

  {
    ...
    correctAnswer: false,
    imgFile: '<img src="assets/images/dandelion.jpg" alt="A Dandelion" >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/octopus.jpg" alt=" An octopus" >',
...

  {
    ...
    correctAnswer: false,
    imgFile: '<img src="assets/images/tea.jpg" alt="Tea leaves on palms " >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/rhino.jpg" alt="Rhinoceroses " >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/peanuts.jpg" alt="Peanuts and a squirrel"  >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/dolphin.jpg" alt=" Dolphins in the sea"  >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/bananas.jpg" alt=" A cluster of bananas " >',
...

  {
    ...
    correctAnswer: false,
    imgFile: '<img src="assets/images/koala.jpg" alt=" A Koala" >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/pineapple.jpg" alt=" A pineapple" >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/sweetpeas.jpg" alt="Sweet peas" >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/otters.jpg" alt=" Sea otters " >',
...

  {
    ...
    correctAnswer: false,
    imgFile: '<img src="assets/images/bamboo.jpg" alt="A Bamboo" >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/loris.jpg" alt="An animal Slow loris" >',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/cucumber.jpg" alt="A Cucumber ">',
...

  {
    ...
    correctAnswer: true,
    imgFile: '<img src="assets/images/cat.jpg" alt="A cat " >',
...

  {
    ...
    correctAnswer: false,
    imgFile: '<img src="assets/images/zebra.jpg" alt="A zebra " >',
